...
from baguetter.indices.sparse.text_preprocessor import get_stopwords
...
def test_get_stopwords_from_lang(supported_languages):
    for lang in supported_languages:
        assert isinstance(get_stopwords(lang), list)
